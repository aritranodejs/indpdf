            ...
            <TabsContent value="draw" className="mt-4 space-y-3">
              ...
              <div className="relative aspect-[4/1.5] w-full overflow-hidden rounded-xl border-2 border-dashed border-crimson/20 bg-white/5 backdrop-blur-sm transition-all hover:border-crimson/40">
                <canvas
                  ...
                  /* Dynamic sizing will be handled by CSS and ref */
                  width={800}
                  height={300}
            ...
            <div className="flex gap-3">
              {ANNOTATION_COLORS.map((c, i) => (
                <button
                  ...
                  className={`h-8 w-8 rounded-full transition-all ${colorIdx === i
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="animate-reveal-up mt-4 max-w-xl text-lg font-medium text-muted-foreground/80 [animation-delay:200ms]">
                {tool.description}
              </p>
            </div>
      ...
      <main className="container mx-auto px-4 py-12 md:py-24">
        <div className="mx-auto max-w-4xl">
          {/* Breadcrumb - refined luxury mapping */}
          <nav className="animate-reveal-up mb-12 flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/60 [animation-delay:100ms]">
            <button
              type="button"
              onClick={() => onNavigate("home")}
